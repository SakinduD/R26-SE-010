...
Pipeline: Scaler(Standard or Robust) -> [PCA] -> SVC(probability=True)
Backend-compatible with SerAnalyzer.EMOTION_MAP in
Backend/app/api/v1/mca/nudge_engine.py. Promoting the trained model into
Backend/ is a separate, explicit step.
"""
