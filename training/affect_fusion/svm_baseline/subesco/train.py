"""
Train the MCA SUBESCO-only SVM Speech Emotion Recognition model.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train a SUBESCO-only MCA SVM SER model.")
    ...
    print("=== MCA SER Training: SUBESCO-only SVM ===")
