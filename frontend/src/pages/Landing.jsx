...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'AI builds every scenario around your personality. Introverts and extroverts get completely different experiences.',
  },
  {
    icon: MessageSquare,
    title: 'Real-time feedback',
    description:
      'Get live coaching on your tone, pacing, and presence — not after the session, but while it’s happening.',
  },
];
    ...
    >
      ...
      >
        <motion.div variants={staggerContainer} initial="initial" animate="animate" style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
          ...
          >
            AI training that gets to know your personality, puts you through live role-play with a virtual
            character, and gives you detailed feedback on how you actually did — voice, expressions, everything.
          </motion.p>
